const formulario =
{
	...
	// Função para enviar os dados do formulario ao console e acompanhar os resultados
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<a href="Pagina_Inicial.html" class="btn btn-primary">Voltar para Página Inicial</a>
					</div>
				</div>
			</div>
		</div>
